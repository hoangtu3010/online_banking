    ...
    <section class="content content-main">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row needs-validation" action="{{url("admin/role/save")}}" method="post"
                          novalidate>
                        @csrf
                        <div class="col-md-12 flex-column pl-3">
                            ...
                            <div class="form-group">
                                <input name="ranker" type="number" class="form-control" id="validationCustom02" placeholder=" "
                                       required/>
