                    ...
                    <form class="row needs-validation" action="{{url("/admin/blog/news/update", ["id" => $news->id])}}"
                        ...
                        <div class="col-md-4 pr-3">
                            <div class="form-image">
                                ...
                                <img src="{{$news->getImage()}}" id="img_tag" style=""/>
                                <input name="image" class="form-control input-post-image" type="file" id="inputImage">
                            </div>
                        </div>
                        <div class="col-md-8 flex-column pl-3">
                            <div class="form-group">
                                <input name="title" type="text" class="form-control" id="validationCustom01" value="{{$news->__get("title")}}" placeholder=" " autocomplete="off"
                                       required/>
                            ...
                            <div class="form-group">
                                <input name="author" type="text" class="form-control" id="validationCustom02" value="{{$news->__get("author")}}" placeholder=" "
                                       required/>
                            ...
                            <div class="form-group">
                                <textarea rows="8" name="content" class="form-control" placeholder=" " id="validationCustom03"
                                          required>{{$news->__get("content")}}</textarea>
